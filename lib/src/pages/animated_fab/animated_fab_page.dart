...
class AnimatedFabPage extends StatelessWidget {
  const AnimatedFabPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Animated Fab')),
      floatingActionButton: const FloatingCircularFAB(),
    );
  }
}

class FloatingCircularFAB extends StatefulWidget {
  const FloatingCircularFAB({super.key});

  @override
  State<FloatingCircularFAB> createState() => _FloatingCircularFABState();
}

class _FloatingCircularFABState extends State<FloatingCircularFAB>
